...
/******/ 	return __webpack_require__(__webpack_require__.s = "./web-src/js/main.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function(global, jQuery) {var $ = __webpack_require__("./node_modules/jquery/dist/jquery.js");
...
__webpack_require__("./web-src/js/spinblock.js");
__webpack_require__("./web-src/js/dictionary.js");
__webpack_require__("./web-src/js/info.js");
...
/* WEBPACK VAR INJECTION */(function($, global) {$(document).ready(function () {
    ...
    var spinblock_data = [];
    var TYPE_BLOCK_DATABASE = 'database';
    var TYPE_BLOCK_NEW = 'newblock';
    var TYPE_BLOCK_STATIC = 'static';
    var TYPE_BLOCK_SPINSENTENCE = 'spinsentence';

    var ACTION_SENTENCE_ADD = 'add';
    var ACTION_SENTENCE_UPDATE = 'update';
    var ACTION_SENTENCE_DELETE = 'delete';
        ...
        for (i = 0; i < spinblock_data.length; i++) {
            if (spinblock_data[i].type != 'newblock') {
                if (i == spinblock_data.length - 2) {
                    $('#select-newblockposition').append('<option value=' + spinblock_data[i].index + ' selected>' + '(' + spinblock_data[i].index + ') - ' + spinblock_data[i].name + '</option>');
                } else {
                    $('#select-newblockposition').append('<option value=' + spinblock_data[i].index + '>' + '(' + spinblock_data[i].index + ') - ' + spinblock_data[i].name + '</option>');
                }
            }
        }
    };
